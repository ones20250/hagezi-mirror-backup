...
**New here?** Start with [Multi PRO](#pro) plus the [Threat Intelligence Feeds](#tif) list, pick the [format that matches](#formatguide) your tool, and follow the [quick setup guide](FAQ.md#quicksetup). Unsure which version fits you? See [which list version should I use](FAQ.md#whatshouldiuse). In a hurry? The [Direct Link Generator](#linkgenerator) hands you both download links in one go.
...
23. [Direct Link Generator](#linkgenerator), build your download links with a few clicks!
24. [Blocklist Lookup](#listlookup), check any domain or IP against every list!
25. [Blocklists Cheat Sheet](CHEATSHEET.md), quick reference table for every list at a glance
26. [Recommendation](#recommendation): [Which list version should I actually use?](FAQ.md#whatshouldiuse)
27. [Online DNS Services](#dnsservices): [AdGuard DNS](#adguarddns) - [ControlD](#controld) - [HaGeZi DNS](#hagezidns) - [DNS Bunker](#dnsbunker) - [Public RDNS](#publicrdns) - [RobinGroppe.de](#robingroppe) - [RethinkDNS](#rethinkdns) - [DNSwarden](#dnswarden) - [OpenBLD.net](#openbld)
28. [About](#about): [Repository](#repository) - [Referral Domains](#referral) - [Support](#support)
29. [FAQ](FAQ.md), frequently asked questions, including the [quick setup guide](FAQ.md#quicksetup) and the [glossary](FAQ.md#glossary)
30. [Discussions](https://github.com/hagezi/dns-blocklists/discussions)
31. [Update Interval/Official Mirrors](#mirrors)
32. [Sources](sources.md)
...
|:--------|:--------------|:-----------------|--------:|-----------------------:|
| :green_book:[Light](#light)        | Relaxed             | Minimal          | 39534    | - |
| :blue_book:[Normal](#normal)       | Relaxed/Balanced    | Low              | 199411    | Light: 39534 |
| :ledger:[Pro](#pro)                | Balanced            | Low to moderate  | 229915      | Mini: 53356 |
| :orange_book:[Pro++](#proplus)     | Balanced/Aggressive | Moderate         | 256743  | Mini: 63807 |
| :closed_book:[Ultimate](#ultimate) | Aggressive          | High             | 282007 | Mini: 77108 |
| :closed_lock_with_key:[TIF](#tif)  | Threats only        | Low              | 2634669      | Medium: 893352<br>Mini: 183774 |
...
> [!IMPORTANT]
> :link: **Don't want to pick a format or copy links by hand? Use the [Direct Link Generator](#linkgenerator).** Select the app or device you use and it sets the format for you, then tick the lists you want and copy every download link in one go: [hagezi-mirror.dnsbunker.org/dlg.html](https://hagezi-mirror.dnsbunker.org/dlg.html)
...
|:---:|:---:|:---:|:---:|:---:|:---:|
| 39534 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/light.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/light.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/light.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/light-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/light.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 199411 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/multi.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/multi.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/multi.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/multi-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/multi.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 229915 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/pro.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/pro.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/pro.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 53356 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/pro.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/pro.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro.mini-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/pro.mini.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 256743 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/pro.plus.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/pro.plus.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro.plus.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro.plus-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/pro.plus.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 63807 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/pro.plus.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/pro.plus.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro.plus.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/pro.plus.mini-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/pro.plus.mini.txt) |
...
>
> **Facebook:**
> Ultimate blocks some META trackers, which limits Facebook and Facebook Messenger app functionality. It also blocks WhatsApp's graph trackers, which can mess with avatar creation, the in-app help center, and video effects. Other than that, WhatsApp works fine. If you use META apps alongside Ultimate, unblock these domains as needed: [META Tracker](dns-blocklists/share/facebook.txt)
>
> **Windows/Xbox:**
> Some Microsoft trackers are blocked too, which can affect things like Windows Spotlight and Xbox Live Achievements Activity History. Check here for details on which domains to unblock for which feature: [Microsoft Tracker](dns-blocklists/share/microsoft.txt).
>
...
>
> **Anything else:**
> More known quirks are listed [here](dns-blocklists/share/ultimate-known-issues.txt).

| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 282007 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/ultimate.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/ultimate.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/ultimate.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/ultimate-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/ultimate.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 77108 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/ultimate.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/ultimate.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/ultimate.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/ultimate.mini-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/ultimate.mini.txt) |

---

### :troll: **Fake, blocks scams, traps, and fake sites!** <a name="fake"></a>

This blocklist targets fake stores, fake streaming sites, rip-offs, subscription traps, and similar scams.

| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 17257 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/fake.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/fake.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/fake.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/fake-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/fake.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 50562 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/popupads.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/popupads.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/popupads.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/popupads-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/popupads.txt) |
...
|:---:|:---:|:---:|:---:|:---:|:---:|
| 2634669 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/tif.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/tif.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/tif.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/tif-onlydomains.txt) | :one: [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/tif-1.txt)<br>:two: [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/tif-2.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 893352 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/tif.medium.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/tif.medium.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/tif.medium.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/tif.medium-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/tif.medium.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 183774 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/tif.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/tif.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/tif.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/tif.mini-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/tif.mini.txt) |

#### :closed_lock_with_key: **Threat Intelligence Feeds, IPs** <a name="tifips"></a>

There's also an IPv4 version of this list, in [plain IP format](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/ips/tif.txt) for firewalls and [AdGuard Home format](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/tif-ips.txt), which extends the regular TIF list.
...
> - Stamus Labs: :green_circle: - Sat, 19 Sep 2026 04:43:42 UTC / 11380772 domains

#### :new: **NRDs:** all newly registered domains, unfiltered

| Time<br>period | Entries | Format<br>Adblock | Format<br>Domains |
|:--------------:|--------:|:-----------------:|:-----------------:|
| 7 days ago to yesterday    | 3624922 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/nrd7.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/nrd7.txt) |
| 14 days ago to 8 days ago  | 2501216 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/nrd14-8.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/nrd14-8.txt) |
| 21 days ago to 15 days ago | 2789966 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/nrd21-15.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/nrd21-15.txt) |
| 28 days ago to 22 days ago | 2331540 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/nrd28-22.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/nrd28-22.txt) |
| 35 days ago to 29 days ago | 2925624 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/nrd35-29.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/nrd35-29.txt) |
...
| Time<br>period | Entries | Format<br>Adblock | Format<br>Domains |
|:--------------:|--------:|:-----------------:|:-----------------:|
| Past 7 days    | 624855 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/dga7.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/dga7.txt) |
| Past 14 days   | 1164274 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/dga14.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/dga14.txt) |
| Past 30 days   | 2454472 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/dga30.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/domains/dga30.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 1539 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/dyndns.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/dyndns.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/dyndns.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/dyndns-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/dyndns.txt) |
...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 1237 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/hoster.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/hoster.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/hoster.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/hoster-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/hoster.txt) | [Link](https://gitlab.com/hagezi/mirror/-/tree/main/dns-blocklists/controld/badware-hoster-folder.json) |
...
| Format | Link | Notes |
|:-------|:-----|:------|
| AdGuard | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/spam-tlds.txt) | For AdGuard and AdGuard Home |
| uBlock Origin | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/spam-tlds-ublock.txt) | For uBlock Origin and Adblock Plus |
| Adblock | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/spam-tlds-adblock.txt) | For Pi-hole and TechnitiumDNS. Spam TLDs with no exclusions |
| Adblock<br>(Aggressive)<br>+ Allowlist | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/spam-tlds-adblock-aggressive.txt)<br>[Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/spam-tlds-adblock-allow.txt) | For Pi-hole and TechnitiumDNS. Use both together |
| Wildcard<br>Domains<br>+ Allowlist | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/spam-tlds-onlydomains.txt)<br>[Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/spam-tlds-allow-onlydomains.txt) | For DNSCrypt. Use both together |
| RPZ | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/spam-tlds-rpz.txt) | Spam TLDs with no exclusions |
| RPZ<br>(Aggressive) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/spam-tlds-rpz-aggressive.txt) | All spam TLDs, matching the AdGuard and uBlock Origin versions |
| ControlD | [Link](https://gitlab.com/hagezi/mirror/-/tree/main/dns-blocklists/controld/spam-tlds-combined-folder.json) | Importable ControlD folder |
...
| Format | Link |
|:-------|:-----|
| AdGuard | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adguard/dns-rebind-protection.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16375 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/doh-vpn-proxy-bypass.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/doh-vpn-proxy-bypass.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/doh-vpn-proxy-bypass.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/doh-vpn-proxy-bypass-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/doh-vpn-proxy-bypass.txt) |

#### :outbox_tray: **Encrypted DNS servers only** <a name="bypass_dns"></a>

| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 3331 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/doh.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/doh.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/doh.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/doh-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/doh.txt) |

#### :outbox_tray: **Encrypted DNS server IPs** <a name="bypass_ips"></a>

There's also an IPv4 version in [plain IP format](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/ips/doh.txt) for firewalls, and an [AdGuard Home format](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/doh-ips.txt).
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 205 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/nosafesearch.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/nosafesearch.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/nosafesearch.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/nosafesearch-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/nosafesearch.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 9965 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/urlshortener.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/urlshortener.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/urlshortener.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/urlshortener-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/urlshortener.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 51469 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/anti.piracy.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/anti.piracy.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/anti.piracy.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/anti.piracy-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/anti.piracy.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 522449 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/gambling.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/gambling.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/gambling.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/gambling-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/gambling.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 190740 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/gambling.medium.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/gambling.medium.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/gambling.medium.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/gambling.medium-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/gambling.medium.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 137114 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/gambling.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/gambling.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/gambling.mini.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/gambling.mini-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/gambling.mini.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 900 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/social.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/social.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/social.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/social-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/social.txt) |
...
| Entries | Adblock | DNSMasq | Wildcard<br>Asterisk | Wildcard<br>Domains | RPZ |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 74152 | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/nsfw.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/nsfw.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/nsfw.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/nsfw-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/nsfw.txt) |
...
|:-------|:--------:|:--------:|:---------:|:--------:|:--------:|
| Amazon (Devices, Shopping, Video) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.amazon.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.amazon.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.amazon.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.amazon-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.amazon.txt) |
| Apple (iOS, macOS, tvOS) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.apple.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.apple.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.apple.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.apple-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.apple.txt) |
| Huawei (Devices) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.huawei.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.huawei.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.huawei.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.huawei-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.huawei.txt) |
| Microsoft (Windows, Office, MSN) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.winoffice.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.winoffice.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.winoffice.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.winoffice-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.winoffice.txt) |
| Samsung | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.samsung.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.samsung.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.samsung.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.samsung-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.samsung.txt) |
| TikTok (Fingerprinting) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.tiktok.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.tiktok.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.tiktok.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.tiktok-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.tiktok.txt) |
| TikTok (Fingerprinting) Aggressive | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.tiktok.extended.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.tiktok.extended.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.tiktok.extended.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.tiktok.extended-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.tiktok.extended.txt) |
| LG webOS | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.lgwebos.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.lgwebos.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.lgwebos.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.lgwebos-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.lgwebos.txt) |
| Roku | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.roku.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.roku.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.roku.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.roku-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.roku.txt) |
| Vivo | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.vivo.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.vivo.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.vivo.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.vivo-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.vivo.txt) |
| OPPO/Realme | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.oppo-realme.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.oppo-realme.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.oppo-realme.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.oppo-realme-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.oppo-realme.txt) |
| Xiaomi | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/native.xiaomi.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/dnsmasq/native.xiaomi.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.xiaomi.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/native.xiaomi-onlydomains.txt) | [Link](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/rpz/native.xiaomi.txt) |

---

### :link: **Direct Link Generator, build your download links with a few clicks!** <a name="linkgenerator"></a>

Rather not click your way through every list section on this page? The **Direct Link Generator** puts the links together for you: [hagezi-mirror.dnsbunker.org/dlg.html](https://hagezi-mirror.dnsbunker.org/dlg.html)

Pick a source and a format, or just select the app or device you use and it sets the format for you. Then pick one Multi tier, tick the add-ons you want, and every matching link shows up at the bottom of the page. Copy them one by one, or grab the whole set with **Copy all links**. The source starts on the build mirror and can be switched to jsDelivr, GitHub, GitLab, or Codeberg, which also makes it an easy way to move an existing setup from one source to another.

It's more than a typing shortcut, because it knows how the lists relate to each other: anything your chosen tier already covers gets greyed out, partial overlaps are spelled out instead of hidden, [NRD and DGA](#nrd) lock each other out, and picking the full [TIF](#tif) list in RPZ format hands you both of its files so you can't end up subscribed to half of it. Lists that are unusually large, or powerful enough to cause trouble if you enable them blindly, carry a small badge as well.
...
Here's how each version performed in that run against the same 10,000-page set, which is also cross-referenced through [whotracks.me](https://whotracks.me/websites.html). All pages were opened and fully loaded in batch via Edge with privacy features turned off, and cookies accepted. The numbers are a snapshot from that benchmark, not live figures from the current build.
...
#### :package: Repository <a name="repository"></a>
