...
>
> Running into one of these issues? Check the known-unblock lists for [Meta](dns-blocklists/share/facebook.txt) and [Microsoft](dns-blocklists/share/microsoft.txt), or the general [known issues list](dns-blocklists/share/ultimate-known-issues.txt).
...
| Format | Link |
|:---|:---|
| Adblock (AdGuard, AdGuard Home, uBlock Origin, etc.) | [Download](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/whitelist-referral.txt) |
| Adblock (Pi-hole v6+, TechnitiumDNS, etc.) | [Download](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/whitelist-referral-native.txt) |
| Wildcard<br>domains | [Download](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/whitelist-referral-onlydomains.txt) |
| ControlD<br>folder | [Download](https://gitlab.com/hagezi/mirror/-/tree/main/dns-blocklists/controld/referral-allow-folder.json) |
...
| Format | Link |
|:---|:---|
| Adblock | [Download](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/blocklist-referral-native.txt) |
| Wildcard<br>domains | [Download](https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/wildcard/blocklist-referral-onlydomains.txt) |
...
- :notebook: Available as a separate [ControlD folder](https://gitlab.com/hagezi/mirror/-/tree/main/dns-blocklists/controld).
...
These lists aren't copies of upstream blocklists. A source listed in [Sources](https://gitlab.com/hagezi/mirror/-/tree/main/dns-blocklists/sources.md) is an input to the build, not something that gets pulled in whole or copied word for word into a tier.
